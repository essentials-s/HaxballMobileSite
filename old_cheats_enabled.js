...
function setupGameUI() {
    if (!document.getElementById("hud-stats")) {
        ...
        hud.id = "hud-stats";
        hud.style.cssText = "position:absolute;top:5px;right:10px;color:white;font-size:14px;z-index:999;background:#000a;padding:5px;border-radius:5px;";
